...
export const weatherApi = {
  ...
  updatePreferences: async (preferences: Preferences): Promise<{ success: boolean }> => {
  ...
  saveLocation: async (name: string, data: WeatherInfo): Promise<{ success: boolean }> => {
  ...
  getAgentState: async (): Promise<{ state: string }> => {
